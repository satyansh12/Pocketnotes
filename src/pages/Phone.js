...
import CreateNotesM from "../components/Popup window/PopupM";
...
function Phone() {
  ...
  return (
    <div className={style.mobile_sidebar}>
      <div className={style.mobile_sidebar_title}>Pocket Notes</div>
      <div className={style.mobile_sidebar_create_notes_btn}>
        <button onClick={handleClick}>
          <span id="add">+</span>
          <span>Create Notes Group</span>
        </button>
      </div>
      <div className={style.mobile_sidebar_notes_title}>
        {titles.length > 0 ? (
      ...
      {showPopup && (
        <div className={style.mobile_popup_overlay}>
        <div ref={popupRef}>
            <CreateNotesM
