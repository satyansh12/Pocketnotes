...
import CreateNotes from "../Popup window/PopupL";
...
function Sidebar() {
  ...
  return (
    <div className={style.sidebar}>
      <div className={style.sidebar_title}>Pocket Notes</div>
      <div className={style.sidebar_create_notes_btn}>
        <button onClick={handleClick}>
          <span id="add">+</span>
          <span>Create Notes Group</span>
        </button>
      </div>
      <div className={style.sidebar_notes_title}>
        {titles.length > 0 ? (
