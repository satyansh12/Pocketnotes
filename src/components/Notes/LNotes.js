...
import style from "./LNotes.module.css";
...
function LNotes() {
  ...
  return (
    <div className={style.notes}>
      <div className={style.notes_title}>
        <div
          className={style.notes_title_color}
          style={{ backgroundColor: bgColor }}
        >
          {initials}
        </div>
        <div className={style.notes_title_text}>{selectedTitle}</div>
      </div>
      <div className={style.notes_content}>
      ...
      <div className={style.notes_input}>
        <textarea
          value={text}
